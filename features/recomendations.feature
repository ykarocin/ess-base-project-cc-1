...
Scenario: Exibir recomendações para um usuário sem histórico de visualizações
...
Feature: Recomendações com base nas curtidas (Em alta/ Top 10) - Ykaro dos Santos Albuquerque
As a usuário da plataforma
I want to receber recomendções que sejam compatíveis com os meus gostos
So that i can desfrutar das recomendações da plataforma
